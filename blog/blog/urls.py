...
from xujia.controllers.auth import user
...
urlpatterns = [
    ...
    url(r'^auth/user/login', user.login, name='user/login'),
    url(r'^auth/user/register', user.register, name='user/register'),
    url(r'^auth/user/logout', user.logout, name='user/logout'),
